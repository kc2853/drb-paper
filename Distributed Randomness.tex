...
\bibitem{Bitcoin}
Nakamoto, Satoshi. ``A peer-to-peer electronic cash system." https://bitcoin.org/bitcoin.pdf (2008).

\bibitem{Aleph}
Gągol, Adam, et al. ``Aleph: Efficient atomic broadcast in asynchronous networks with byzantine nodes." Proceedings of the 1st ACM Conference on Advances in Financial Technologies. 2019.
