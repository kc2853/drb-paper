...
While this may seem to contradict the fault tolerance of delay-based DRBs from Section~\ref{section:vdf}, we note that delay functions help circumvent Cleve's impossibility result in two ways as follows.
