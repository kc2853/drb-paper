...
\begin{enumerate}
    ...
    \item \textbf{Inform.} Any colluding participant that preemptively knows $\drboutput_\epochv$ is incentivized to inform $\escrow$ to earn a informing reward obtained via collective punishment. %Due to this phase, the incentive is that no one should collude.
