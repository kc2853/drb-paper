...
% 1. Introduction
% * recent randomness applications
% * randomness beacon -- first formalized by Rabin
% * NIST randomness beacon -- but we have to trust NIST
% * how can we not trust NIST / avoid central point of failure? -> distribution of trust -> DRB
% * In this paper: we do xyz

% 2. "Formalization" Section
% * Perfect Synchrony -> centralization issue
% * commit-reveal -> last revealer attack issue
% * definitions of ideal DRB
% * formalization/system/adversary/notation model
