...
\end{itemize}
A Strongly Unique Trapdoor VDF can be described by the algorithms $TVDF = (Setup,VerifySetup, TrapdoorEval, Eval, Verify)$. It extends a traditional VDF with:
\begin{itemize}
